    ...
    <Card className="group hover:shadow-lg transition-all duration-300 border-0 shadow-sm bg-gradient-to-br from-white to-gray-50/50 h-full w-full">
      <CardContent className="p-3 sm:p-4 md:p-6 h-full flex flex-col">
        ...
        <div className="flex items-start gap-2 sm:gap-3 md:gap-4 mb-3 sm:mb-4">
          <Avatar className="h-10 w-10 sm:h-12 sm:w-12 md:h-14 md:w-14 ring-2 ring-blue-100 group-hover:ring-blue-200 transition-all flex-shrink-0">
            <AvatarImage
        ...
        {suggestion.has_pending_request ? (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-3 sm:p-4 mb-4 flex-1 flex items-center">
            <div className="flex items-center gap-3 w-full">
              <div className="flex-shrink-0">
                <Clock className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 animate-pulse" />
              </div>
              <div className="flex-1">
                <p className="font-medium text-blue-900 text-xs sm:text-sm">Demande en attente</p>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="space-y-3 mb-4 flex-1">
              <Select value={selectedRelationType} onValueChange={setSelectedRelationType}>
                <SelectTrigger className="w-full h-10 sm:h-11 bg-white border-gray-200 hover:border-gray-300 focus:border-blue-500 transition-colors text-sm">
            ...
            <div className="mt-auto">
              <Button
                ...
                className="w-full h-10 sm:h-11 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium transition-all duration-200 disabled:opacity-50 text-sm"
              >
